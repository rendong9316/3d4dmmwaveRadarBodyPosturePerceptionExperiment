...
def main():
    ...
    for ep in range(N_EPOCHS):
        ...
        if vl_a>best_acc: best_acc=vl_a; torch.save(model.state_dict(), os.path.join(os.path.dirname(__file__),'best_model.pth'))
    ...
    plt.tight_layout(); plt.savefig(os.path.join(os.path.dirname(__file__),'training_results.png'),dpi=150)
